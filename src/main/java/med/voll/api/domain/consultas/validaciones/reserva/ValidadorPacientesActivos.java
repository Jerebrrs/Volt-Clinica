...
@Component
public class ValidadorPacientesActivos implements ValidadorDeConsultas {
    @Autowired
    ...
    public void validar(DatosReservaConsulta datos) {
        ...
        if(!pacienteEstaActivo){
            throw new ValidacionException("Consulta no puede ser reservada con paciente excluidos.");
        }
    }
}
